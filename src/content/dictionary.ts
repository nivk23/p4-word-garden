...
export const dictionaryMeanings: Record<string, string> = {
  ...
  "admiring": "look at with admiration",
  "adorable": "lovable especially in a childlike or naive way",
  "advantage": "the quality of having a superior or more favourable position",
  ...
  "backbone": "the part of a book's cover that encloses the inner side of the book's pages and that faces outward when the bo",
  ...
  "brave": "brightly coloured and showy",
  ...
  "cedar": "durable aromatic wood of any of numerous cedar trees",
  ...
  "channel": "a deep and relatively narrow body of water (as in a river or a harbour or a strait linking two larger bodies) t",
  ...
  "comment": "a report (often malicious) about the behaviour of other people",
  ...
  "crab": "decapod having eyes on short stalks and a broad flattened carapace with a small abdomen folded under the thora",
  ...
  "crystal": "colourless glass made of almost pure silica",
  ...
  "delivered": "bring to a destination, make a delivery",
  ...
  "episodes": "a brief section of a literary or dramatic work that forms part of a connected series",
  ...
  "give": "organise or be responsible for",
  ...
  "gossip": "a report (often malicious) about the behaviour of other people",
  ...
  "helmet": "armour plate that protects the head",
  ...
  "inches": "a unit of measurement for advertising space",
  ...
  "keeps": "cause to continue in a certain state, position, or activity; e.g., `keep clean'",
  ...
  "laboratory": "a region resembling a laboratory inasmuch as it offers opportunities for observation and practice and experime",
  ...
  "meant": "mean or intend to express or convey",
  ...
  "measured": "have certain dimensions",
  ...
  "mingling": "be all mixed up or jumbled together",
  ...
  "opinion": "a message expressing a belief about something",
  ...
  "party": "an organisation to gain political power",
  ...
  "profile": "an analysis (often in graphical form) representing the extent to which something exhibits various characterist",
  ...
  "promised": "give grounds for expectations",
  ...
  "rude": "being unprocessed or manufactured using only simple or minimal processes",
  ...
  "scanner": "a radio receiver that moves automatically across some selected range of frequencies looking for some signal or",
  ...
  "scratches": "an abraded area where the skin is torn or worn off",
  ...
  "skates": "sports equipment that is worn on the feet to enable the wearer to glide along and to be propelled by the alter",
  ...
  "soft": "; produced with the back of the tongue raised toward the hard palate",
  ...
  "stepsister": "a sister who has only one parent in common with you",
  ...
  "tendency": "an attitude of mind especially one that favours one alternative over others",
  "tender": "hurting",
  ...
  "think": "use or exercise the mind or one's power of reason in order to make inferences, decisions",
  ...
  "tooth": "hard bonelike structures in the jaws of vertebrates; used for biting and chewing or for attack and defence",
  ...
  "unit": "an organisation regarded as part of a larger social group",
